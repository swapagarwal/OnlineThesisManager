...
<html>
    ...
    <body>
        <div id="bodyPanel">
            ...
            <div id="adminMiddle">
               <div id="mTPanel">
                    <div id="mTPanelTitle">List of all M.Tech students</div>
					<div id="mTpanelTitle">
      <center>
                    <form method="POST">
				...
				if(isset($_POST['searchbox']))
                    $result = getALLStudentss("MT",$_POST['searchbox']);
                    else
                    $result = getAllStudentss("MT","");
                //$result = getAllStudents("MT");
                if ($result == "DONE") {
                    ...
                    echo '<div id="ListOddRow" style="text-align: center; color: #990033">No M.Tech student found.</div>';
                } else {
